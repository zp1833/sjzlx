package com.alphasta.cms.successfulCase.webapp;
...
import com.alphasta.cms.successfulCase.service.SuccessfulCaseManager;
...
public class SuccessfulCaseAction extends BaseECLimitQueryAction<SuccessfulCase, SuccessfulCaseManager> {
	...
	public String saveSuccessfulCase() {
	...
	protected DetachedCriteria setupDetachedCriteria() {
		DetachedCriteria c = DetachedCriteria.forClass(SuccessfulCase.class);
