...
<table align="left" bgcolor="#FFFFFF" cellpadding="2" cellspacing="1">
    ...
    <tr>
		...
		<td bgcolor="#EBEBEB" width="20">
	  	...
	  	<td align="right" bgcolor="#EBEBEB" width="130">存款证明</td>
		<td bgcolor="#EBEBEB" width="20">
    ...
    <tr>
		...
		<td bgcolor="#EBEBEB" width="20" colspan="3">
    ...
    <tr>
		...
		<td bgcolor="#EBEBEB" colspan="9">
			${model.otherApplyProveDoc }
	  	</td>
    </tr>
</table>
</fieldset>
