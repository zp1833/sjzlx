if(!dojo._hasResource["jsam.shadow"]){ //_hasResource checks added by build. Do not use _hasResource directly in your code.
	dojo._hasResource["jsam.shadow"] = true;
	dojo.provide("jsam.shadow");
	
	(function(){
	jsam.shadow = function (node) {
		this.shadowPng = dojo.moduleUrl("jsam.resources", "images/shadow");
