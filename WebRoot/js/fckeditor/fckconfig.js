...
FCKConfig.ImageBrowserWindowWidth  = FCKConfig.ScreenWidth * 0.6 ;	// 70% ;
FCKConfig.ImageBrowserWindowHeight = FCKConfig.ScreenHeight * 0.6 ;	// 70% ;
...
FCKConfig.ImageUploadURL = '../../../../admin/fileupload/upload.do';
