...
<body>
<s:form namespace="/admin/dealinginfo" action="saveDealingInfo" theme="simple" method="POST" onsubmit="return checkForm();">
	<div class="x-panel">
	    <div class="x-panel-header">添加现操作客户信息</div>
		        ...
		        <tr>
		          <td height="110">
					<div id='SystopTabDiv1'>
						<%@include file="dealingInfoDetail.jsp" %>
					</div>
