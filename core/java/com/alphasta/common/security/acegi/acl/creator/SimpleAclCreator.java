package com.alphasta.common.security.acegi.acl.creator;
...
import com.alphasta.common.security.acegi.acl.AclUtils;
import com.alphasta.common.security.acegi.acl.domain.AclDomainAware;
...
public class SimpleAclCreator extends AbstractBasicAclCreator {
  ...
  /**
   * @see com.alphasta.common.security.acegi.acl.AclCreator#
  ...
  protected SimpleAclEntry[] getEntry(Authentication authentication,
    ...
    for (int i = 0; i < authoritys.length; i++) {
      ...
      if (auth.getAuthority().startsWith("ACL_")) { 
        SimpleAclEntry aclEntry = new SimpleAclEntry(auth.getAuthority(),
            aclIdentity, parentAclIdentity, defaultRoleMask.intValue());
        list.add(aclEntry);
      }
    }
  ...
  /**
   * @see com.alphasta.common.security.acegi.acl.AclCreator#supports(Class)
   */
  public boolean supports(Object domainObject, Object returnedObject) {
    return ((domainObject == null && processDomainObjectClass == null) 
        || this.processDomainObjectClass
        .isAssignableFrom(domainObject.getClass()))
        && ((returnedObject == null && processReturnedObjectClass == null) 
            || this.processReturnedObjectClass
